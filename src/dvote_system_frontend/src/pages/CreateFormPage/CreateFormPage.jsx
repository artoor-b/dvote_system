...
export const CreateFormPage = ({ userRole }) => {
  ...
  const onGoBack = () => {
    console.log("isSubmitResultStep", isSubmitResultStep);
    setIsSubmitResultStep(() => false);
  };
      ...
      <div className="flex flex-col p-6 min-h-min">
        ...
        <section className="flex flex-wrap lg:flex-nowrap">
          ...
          <div className="w-full lg:w-1/2 p-6 bg-white rounded-lg">
            ...
            {/* Date input */}
            <div className="mb-6 flex flex-wrap gap-5 md:flex-nowrap xl:justify-between">
              <div>
                <label
                  className="block text-sm font-normal leading-4 mb-2 justify-self-start"
                  htmlFor="formDate"
          ...
          {/* Right Column */}
          <div className="w-full lg:w-1/2 p-6 bg-white ml-4">
